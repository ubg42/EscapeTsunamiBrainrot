const unityApp = {
    ...
    startLoading: function () {
        ...
        const loaderUrl = buildUrl + "/escape-tsunami-brainrot[3]-mirraSDK[5.0.18].loader.js";
        const config = {
            arguments: [],
            dataUrl: buildUrl + "/escape-tsunami-brainrot[3]-mirraSDK[5.0.18].data.br",
            frameworkUrl: buildUrl + "/escape-tsunami-brainrot[3]-mirraSDK[5.0.18].framework.js.br",
            codeUrl: buildUrl + "/escape-tsunami-brainrot[3]-mirraSDK[5.0.18].wasm.br",
            streamingAssetsUrl: "StreamingAssets",
            companyName: "DefaultCompany",
            productName: "escape-tsunami-brainrot",
